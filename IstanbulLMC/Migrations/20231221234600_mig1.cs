        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeateCount = table.Column<int>(type: "int", nullable: false),
                    SuitcaseCount = table.Column<int>(type: "int", nullable: true),
                    MaxDistance = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    KMPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Image = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    InsertID = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    InsertDate = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FromPlaceID = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    FromPlace = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ToPlaceID = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    FlieghtNo = table.Column<string>(type: "nvarchar(max)", nullable: true),
